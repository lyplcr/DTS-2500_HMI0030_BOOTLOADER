...
#define SF_CS_PIN			GPIO_Pin_0
#define SF_MISO_GPIO		GPIOC
#define SF_MISO_PIN			GPIO_Pin_2
#define GPIO_PinSource_MISO	GPIO_PinSource2
#define SF_MOSI_GPIO		GPIOC
#define SF_MOSI_PIN			GPIO_Pin_3
#define GPIO_PinSource_MOSI	GPIO_PinSource3  
#define SF_SCK_GPIO			GPIOB
#define SF_SCK_PIN			GPIO_Pin_10
#define GPIO_PinSource_SCK	GPIO_PinSource10
...
void bsp_InitSFlash(void)
{
	...
	GPIO_PinAFConfig(SF_SCK_GPIO, GPIO_PinSource_SCK, GPIO_AF_SPI2);
	GPIO_PinAFConfig(SF_MISO_GPIO, GPIO_PinSource_MISO, GPIO_AF_SPI2);
	GPIO_PinAFConfig(SF_MOSI_GPIO, GPIO_PinSource_MOSI, GPIO_AF_SPI2);
	...
	GPIO_InitStructure.GPIO_Pin = SF_MISO_PIN;
	GPIO_Init(SF_MISO_GPIO, &GPIO_InitStructure);
	GPIO_InitStructure.GPIO_Pin = SF_MOSI_PIN;
	GPIO_Init(SF_MOSI_GPIO, &GPIO_InitStructure);
	GPIO_InitStructure.GPIO_Pin = SF_SCK_PIN;
	GPIO_Init(SF_SCK_GPIO, &GPIO_InitStructure);
