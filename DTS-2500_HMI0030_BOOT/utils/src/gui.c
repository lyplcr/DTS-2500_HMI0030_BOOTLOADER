...
void CheckPrmWarning( void )
{
	...
	if (SET == GetPrmWarnStatus() )
	{
		...
		if ((pPrmReply->err==STATUS_ERROR_FULL_SCALE_KY) || (pPrmReply->err==STATUS_ERROR_FULL_SCALE_KZ))
		{
			if (g_popWindows.exceptionShieldCode == STATUS_OK)
			{
