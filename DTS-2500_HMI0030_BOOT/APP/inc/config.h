...
#define		TIME_PASSWARD_PUTIN		10									//输入密码等待时间（分钟）
#define		VALVE_RESET_DEGREE		-6400								//阀口复位开度

#define		SYSTEM_VERSION			"DTS-2500"							//系统版本
#define		PCB_DISP_VERSION		"HMI0030"							//上位机PCB版本
#define		SOFT_DISP_VERSION		"Ver 1.3.0"							//上位机软件版本	
/*
	软件版本规则：
